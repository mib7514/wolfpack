...
const BASE = {
  ...
  monthlyData: [
    { month:"Jan",m2024:18,m2025:18,label:"1월" },{ month:"Feb",m2024:19,m2025:24,label:"2월" },
    { month:"Mar",m2024:36,m2025:17,label:"3월" },{ month:"Apr",m2024:33,m2025:15,label:"4월" },
    { month:"May",m2024:10,m2025:16,label:"5월" },{ month:"Jun",m2024:12,m2025:17,label:"6월" },
    { month:"Jul",m2024:37,m2025:11,label:"7월" },{ month:"Aug",m2024:20,m2025:19,label:"8월" },
    { month:"Sep",m2024:186,m2025:39,label:"9월" },{ month:"Oct",m2024:60,m2025:53,label:"10월" },
    { month:"Nov",m2024:53,m2025:45,label:"11월" },{ month:"Dec",m2024:333,m2025:null,label:"12월" },
  ],
  annualData: [
  ...
  newsItems: [
    ...
    { date:"2025.12.xx",title:"WGC: 2025 연간 CB 순매입 863t, -17%",tag:"데이터",impact:"→",color:T2 },
  ],
  events: [
      ...
      <div style={{ padding:"14px 18px",maxWidth:1100,margin:"0 auto" }}>
        ...
        {tab === "overview" && (<div>
          <div style={{ display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:8,marginBottom:14 }}>
            {[
              ...
              { label:"2025 최대 매입국",value:"폴란드",sub:"102t",c:BLU },
              { label:"2026E CB 전망",value:"755~850t",sub:"JPM/WGC",c:GRN },
              { label:"IB 컨센 YE'26",value:"$5,180",sub:"Wall St Avg",c:ORG },
            ].map((k,i) => (
        ...
        {tab === "purchases" && (<div>
          <div style={{ background:BGC,borderRadius:12,padding:16,border:`1px solid ${BD}`,marginBottom:12 }}>
            ...
            <p style={{ fontSize:10,color:T3,margin:"0 0 12px" }}>2024 vs 2025</p>
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={BASE.monthlyData} margin={{top:5,right:8,left:-4,bottom:0}}>
                ...
                <Bar dataKey="m2024" name="2024" fill={BLU} radius={[3,3,0,0]} barSize={14} />
                <Bar dataKey="m2025" name="2025" fill={GOLD} radius={[3,3,0,0]} barSize={14} />
              </BarChart>
            </ResponsiveContainer>
          </div>
          <div style={{ background:BGC,borderRadius:12,padding:16,border:`1px solid ${BD}`,marginBottom:12 }}>
